#ifndef __FISSION_REPLACEMENT_POLICY_H__
#define __FISSION_REPLACEMENT_POLICY_H__

#include "replacement_policy.h"
#include <climits>

class Fission : public BasePolicy {
    ...
    Fission(uint64_t _set_idx, uint64_t _num_ways, uint64_t _level):
